										...
										<div style="Margin-left: 20px;Margin-right: 20px;">
											<?php
												...
												foreach($items as $item){
													$idx++;
											?>
											<div style="border: 1px solid #eee; border-radius: 5px; padding: 15px 25px; margin-bottom: 15px;">
												<div style="max-width: 100%; margin-left: 20px; margin-right: auto;">
													<div style="width: 100%; position: relative;">
														<div style="display: inline-block; color: black;"><?php echo $idx;?>.&nbsp;&nbsp;<?php echo $item->desc;?>(<?php echo $item->v_desc;?>)&nbsp;&nbsp;*&nbsp;&nbsp;
															<span style="font-weight: 900; color: brown;"><?php echo $item->qty;?></span>
															&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
															<span style="position: absolute; right: 0; top: 0; color: blue;">$<?php echo $item->subtotal;?></span>
														</div>
													</div>
												</div>
											</div>
